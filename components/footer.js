    ...
    return (
        <>
            ...
            <div className='footer w-full h-72 flex'>
                <div className="hidden md:flex flex-row justify-center basis-1/3">
                    <ul className="text-center p-5">
                        <li className="h-12"><h2 className="text-heading">SOCIAL MEDIA'S</h2></li>
                        <li className="h-12 w-fit sm:w-full flex gap-1 justify-center text-center">
                            <a href="" className="hidden md:block text-heading">Instagram</a>
                        </li>
                        <li className="h-12 w-fit sm:w-full flex gap-1 justify-center text-center">
                            <a href="" className="hidden md:block text-heading">FACEBOOK</a>
                        </li>
                    </ul>
                </div>
                        ...
                        {randomTitles.map((title) => (
                            <li className="flex justify-center items-center h-12" key={title.sys.id}>
                                <Link href={`/recept/${title.fields.slug}`}>
                                    <p className="text-heading truncate">{title.fields.titel}</p>
                                </Link>
                            </li>
                        ))}
                    </ul>
                ...
                <div className="flex flex-row justify-center basis-1/2 md:basis-1/3">
                    <ul className="text-align-center">
                        <Link href="/" className={router.pathname == '/' ? "underline decoration-[#FF7500] underline-offset-2 bg-black shadow font-cinzel m-auto w-1/4" : "bg-black shadow font-cinzel m-auto w-1/4"}>
                            <li className="flex justify-center items-center h-12">Home</li>
                        </Link>
                        <Link href="/recepten" className={router.pathname === '/recepten' || router.pathname.startsWith('/recept/') ? "underline decoration-[#FF7500] underline-offset-2 bg-black shadow font-cinzel m-auto w-1/4" : "bg-black shadow font-cinzel m-auto w-1/4"}>
            ...
            <div className="footer w-full h-16 flex flex-row justify-around border-t border-white">
                <div className="flex text-center self-center font-cinzel"><h2>Copyright 2023</h2></div>
                ...
                <div className="flex text-center self-center font-cinzel"><h2>Realisatie: Joran</h2></div>
            </div>
        </>
    )
}
